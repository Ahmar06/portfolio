      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            "Hi, I'm a passionate Web Developer with a deep love for Next.js, Tailwind CSS, Sanity.io, and shadcn/ui. With 6 months of experience, I specialize in creating user-friendly websites and innovative solutions that blend creativity and functionality. I’m always eager to learn, grow, and take on new challenges. When I’m not working. Let’s connect and create something incredible together!"
            </p>
            {/* <p className="mb-5 leading-relaxed">
